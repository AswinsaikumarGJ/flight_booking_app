...
class _ScreenSixState extends State<ScreenSix> {
  ...
  var w = MediaQuery.of(context).size.width;
    return SafeArea(
      child: WillPopScope(
        onWillPop: (){
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ScreenSeven()));
                      ...
                      child: Stack(
                        children: [
                          Positioned(
                            top: h * 0.03,
                            left: w * 0.06,
                            child: Text("Booking Your",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold),)),
                    ...
                    child: Stack(
                      children: [
                        Positioned(
                          top: h * 0.03,
                          left: w * 0.06,
                          child: Text("Vacation in Maldives",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18))),
                                            Positioned(
                                              top: h * 0.09,
                                              left: w * 0.07,
                                            child: Text("CHLD",style: TextStyle(color: Colors.orange,fontSize: 20,fontWeight: FontWeight.bold),)),
                                            Positioned(
                                              top: h * 0.13,
                                              left: w * 0.07,
                    ...
                    child: Stack(
                      children: [
                        Positioned(
                          ...
                          top: h * 0.04,
                          left: w * 0.55,
                          child: Text("Adults",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),)),
                          Positioned(
                            top: h * 0.09,
                            left: w * 0.55,
                            child: Container(
                          ...
                          top: h * 0.25,
                          left: w * 0.55,
                          child: Text("Infants",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),)),
                          Positioned(
                            top: h * 0.3,
                            left: w * 0.55,
                            child: Container(
                          ...
                          top: h * 0.25,
                          left: w * 0.06,
                          child: Text("Children",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),)),
                          Positioned(
                            top: h * 0.3,
                            left: w * 0.07,
                            child: Container(
                    ...
                    child: Stack(
                      children: [
                        Positioned(
                          top: h * 0.03,
                          left: w * 0.07,
                          child: Text("Cabin",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18))),
                                ...
                                setState(() {
                                  selectedindex = index;
                                           ...
                                           child: Container(
                                                                 ...
                                                                 width: 130,
                                                                 height: 80,
                                                                 decoration: BoxDecoration(color:index == selectedindex ? Colors.teal : Colors.white,borderRadius: BorderRadius.circular(30)),
                                                                 child: Center(child: Text("${cabinname[index]}",style: TextStyle(color: index == selectedindex ? Colors.white : Colors.black),)),
                                           ),
                                         );
                                       })
                                       ),
                   ...
                   InkWell(
                    onTap: (){
                     ...
                     child: Container(
                      ...
                      child: Stack(
                        children: [
                          Positioned(top: h * 0.027,left: w * 0.31,child: Text("Proceed",style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),)),
                        ],
                      )
                                     ),
                   ),
